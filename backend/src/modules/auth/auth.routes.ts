...
import { handleLogin, handleRegister } from "./auth.credentials.controller";
...
authRouter.get("/facebook", (req, res) => {
  void controller.handleFacebookRedirect(req, res);
});

authRouter.get("/facebook/callback", (req, res) => {
  void controller.handleFacebookCallback(req, res);
});
